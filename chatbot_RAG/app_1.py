...
Nếu thông tin không có trong ngữ cảnh, hãy trả lời dựa trên kiến thức chung về luật pháp Việt Nam nhưng cần lưu ý người dùng nên liên hệ trực tiếp với bộ phận hành chính liên quan để được hướng dẫn chính xác nhất.
...
def main():
    ...
    # input
    if question := st.chat_input("Nhập câu hỏi về thủ tục đăng ký kết hôn..."):
